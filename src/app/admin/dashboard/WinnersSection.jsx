...
const WinnersSection = () => {
  ...
  const handleDeleteWinner = async (winnerId) => {
    ...
    try {
      setLoading(true);
      const response = await fetch(`/api/events/winners/delete?eventId=${selectedEvent._id}&winnerId=${winnerId}`, {
        method: 'DELETE'
      });
            ...
            {winners.length === 0 ? (
              <div className="text-center py-16">
                <div className="bg-white/5 rounded-3xl p-12 inline-block">
                  ...
                  <h3 className="text-2xl font-semibold text-white mb-3">No Winners Yet</h3>
                  <p className="text-slate-400 text-lg">Add the first winner to get started!</p>
                </div>
              </div>
            ) : (
          ...
          <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50 p-4">
            <div className="bg-slate-800/90 backdrop-blur-xl rounded-3xl border border-white/20 w-full max-w-md max-h-[90vh] overflow-y-auto shadow-2xl">
              <div className="p-8">
                ...
                <form onSubmit={editingWinner ? handleEditWinner : handleAddWinner} className="space-y-6">
                  <div>
                    ...
                    >
                      ...
                      {imagePreview ? (
                        <div className="text-center">
                          ...
                          />
                          <p className="text-sm text-slate-300">Click or drag to replace</p>
                        </div>
                      ) : (
                        <div className="text-center">
