            ...
            <div className="relative overflow-hidden rounded-xl bg-white/5 backdrop-blur-sm border border-white/10 hover:border-white/20 transition-all duration-300 group-hover:shadow-2xl group-hover:shadow-blue-500/10">
                ...
                <div className="absolute inset-0 overflow-hidden rounded-xl pointer-events-none">
                    <BorderBeam
                        duration={20}
                        size={300}
                        className="from-transparent via-blue-400/40 to-transparent opacity-60"
                    />
                </div>
                ...
                <div className="relative z-10 p-6 lg:p-8">
                    <div className="flex flex-col lg:flex-row gap-6 lg:gap-8">
                        ...
                        <div className="flex-shrink-0 mx-auto lg:mx-0">
                            <div className="relative w-56 h-56 lg:w-64 lg:h-64 rounded-lg overflow-hidden ring-2 ring-white/10 group-hover:ring-blue-400/30 transition-all duration-300">
                                <Image
                                    src={team.image}
                                    alt={team.title}
                                    fill
                        ...
                        <div className="flex-1 flex flex-col justify-between min-h-0">
                            <div className="text-center lg:text-left">
                                <h3 className="text-2xl lg:text-3xl font-bold text-white mb-4 font-heading tracking-wide">
                                    {team.title}
                                </h3>
